...
function initialiseTemplateEngine(app) {
  ...
  nunjucksEnvironment.addGlobal(
    "nationalityList",
    autocompleteUtil.nationalityList,
  );
  ...
  nunjucksEnvironment.addGlobal(
    ...
    availability.MAINTENANCE_END_DATETIME,
  );
