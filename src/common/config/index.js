...
exports.NOTIFY_ONE_LOGIN_INVITE_TEMPLATE_ID = process.env.NOTIFY_ONE_LOGIN_INVITE_TEMPLATE_ID;
...
exports.NOTIFY_ONELOGIN_NEW_USER_REGISTERED_EMAIL_TEMPLATE_ID =
  process.env.NOTIFY_ONELOGIN_NEW_USER_REGISTERED_EMAIL_TEMPLATE_ID;
exports.NOTIFY_ADMIN_ABOUT_USER_EMAIL_CHANGE_TEMPLATE_ID = process.env.NOTIFY_ADMIN_ABOUT_USER_EMAIL_CHANGE_TEMPLATE_ID;
